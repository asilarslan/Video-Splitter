/*FFmpeg'den komutları
  Dizge olarak EncodeVideo komutları ararken kullanana encodingCommand
İstediğiniz kadar kaldır ekle*/
namespace VideoEncoder
{
    public class QuickVideoEncodingCommands
    {
        ...
        // http://www.wikihow.com/Convert-a-Flash-Video-File-(.flv)-to-MP4-with-FFMpeg dönüştürme
        ...
        ///usr/bin/ffmpeg -i 175.mp4 -f mp4 -vcodec copy -acodec copy -ss 1 -t 2 -y 634955063880033826.mp4 
    }
}